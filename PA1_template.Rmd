...
```
The mean and median of the total steps taken per day are `r mean1` and `r median1` respectively.
...
```
There are `r num_nas` missing values.
...
The mean and median for total step taken per day can be recaluclated using the imputed data and are `r mean2` and `r median2` respectively.
